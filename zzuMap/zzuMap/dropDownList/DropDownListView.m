...
//        self.mTableBaseView = [[UIView alloc] initWithFrame:CGRectMake(self.frame.origin.x, self.frame.origin.y + self.frame.size.height , self.frame.size.width, self.mSuperView.frame.size.height - self.frame.origin.y - self.frame.size.height)];
        self.mTableBaseView = [[UIView alloc] initWithFrame:CGRectMake(self.frame.origin.x-50, self.frame.origin.y + self.frame.size.height , self.frame.size.width, self.mSuperView.frame.size.height - self.frame.origin.y - self.frame.size.height-280)];
//        self.mTableBaseView.backgroundColor = [UIColor colorWithWhite:0.0f alpha:0.5];
        ...
        self.mTableView = [[UITableView alloc] initWithFrame:CGRectMake(self.frame.origin.x, self.frame.origin.y + self.frame.size.height, self.frame.size.width, 160) style:UITableViewStylePlain];
    ...
    CGRect rect = self.mTableView.frame;
    rect.origin.x = sectionWidth *(section+1);
    rect.size.width = sectionWidth+100;
//    NSLog(@"======%d,---%d",sectionWidth,[self.dropDownDataSource numberOfSections]);
    rect.size.height = 0;
