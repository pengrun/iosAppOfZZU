...
- (void)viewDidLoad
{
    ...
    for (int i=0; i<[array count]; i++) 
    {
        ...
        [btn setFrame:CGRectMake(60+50*i,420+65,52,40)];
    ...
    switch (btn.tag) {
        ...
        case 5://保存.
        {
           ...
           UIImageWriteToSavedPhotosAlbum(self.imageView.image, self, @selector(imageSavedToPhotosAlbum: didFinishSavingWithError: contextInfo:), nil); 
            [[SHKActivityIndicator currentIndicator] displayActivity:@"正在保存图片..." inView:self.view];
...
{
    [[EGOCache currentCache] removeCacheForKey:imgUrl];
