...
//    self.mapView.frame = self.view.bounds;
    ...
    self.mapView.frame=CGRectMake(0, 65, 320, 568-50);
    self.mapView.delegate = self;
    
    [self.view addSubview:self.mapView];
    
    self.mapView.centerCoordinate=CLLocationCoordinate2DMake(34.786856,113.661391);
    MACoordinateSpan span;
    span.latitudeDelta=0.009;
    span.longitudeDelta=0.004;
    
    MACoordinateRegion region={CLLocationCoordinate2DMake(34.781856,113.663991),span};
